...
export default function ManualBookIndex() {
    ...
    const handleDownload = () => {
        toastHelper.fileDownloaded('Manual Book');
        window.location.href = route('manualbook.download');
    };

    const handleOpenNewTab = () => {
        window.open(route('manualbook.view'), '_blank');
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Manual Book - Panduan Pengguna" />
                    ...
                    <div className="flex items-start justify-between mt-4">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-4">
                                Panduan lengkap penggunaan sistem pembelajaran
                            </p>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            <p className="text-sm text-blue-900 dark:text-blue-100 font-medium">
                                Tips Penggunaan Manual Book
                            </p>
                            <ul className="text-sm text-blue-700 dark:text-blue-300 mt-2 space-y-1 list-disc list-inside">
                                <li>Gunakan kontrol zoom untuk memperbesar/memperkecil tampilan</li>
                                <li>Scroll untuk melihat seluruh isi dokumen</li>
                                <li>Buka di tab baru untuk tampilan layar penuh</li>
                                <li>Download PDF untuk akses offline</li>
                            </ul>
                        </div>
                    </div>
                </div>
