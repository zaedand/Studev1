                ...
                <div className="relative z-10 w-full max-w-md">
                    ...
                    <div className="bg-gray-900/40 backdrop-blur-xl rounded-2xl border border-gray-700/50 shadow-2xl p-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-400 text-sm">Enter your new password below to reset your account</p>
                        </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="bg-gray-800/30 border-gray-600/50 text-gray-400 cursor-not-allowed"
                                    />
